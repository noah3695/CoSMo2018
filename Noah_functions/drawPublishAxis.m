...
if ~isempty(titleStr)
  dpa.axis.title = text(titleX,titleY,titleStr,'HorizontalAlignment','center','VerticalAlignment',titleAlignment,'FontSize',labelFontSize+5,'FontAngle','oblique','FontName',fontName);
end
